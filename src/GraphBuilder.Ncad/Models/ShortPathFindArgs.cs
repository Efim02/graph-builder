...
/// </summary>
public class ShortPathFindArgs
{
    /// <summary>
    ...
    public ShortPathFindArgs(long startVertexId, long endVertexId, bool success)
    {
    ...
    /// </summary>
    public static ShortPathFindArgs False()
    {
        return new ShortPathFindArgs(-1, -1, false);
    }
}